...
flags.DEFINE_float('reg_scale', 0.0, 'Regularization scale.')
flags.DEFINE_float('dropout', 1.0, 'Dropout for regularization.')
# logging
...
def create_model(sess, vocab, forward_only=False):
    model = VariationalAutoEncoder(
        ...
        FLAGS.dropout, _buckets, vocab, forward_only)
